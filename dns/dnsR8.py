...
ip = ("\""+str(oct1) +".in-addr.arpa\"")

ipFile = (str(oct1)  + "."  + "in-addr.arpa.hosts")

ipZoneLine =  ("zone \""+str(oct1)  + "."  + "in-addr.arpa\" IN {")
#print(ipZoneLine)
...
if str(ipZoneLine) not in zonelist:
        ...
        zoneConfig.write (''+oct4www+'.'+oct3+'.'+oct2+'  IN      PTR     www.'+domName+'.pt.\n')
        zoneConfig.write (''+oct4ftp+'.'+oct3+'.'+oct2+'  IN      PTR     ftp.'+domName+'.pt.\n')
        zoneConfig.close()
...
if str(ipZoneLine) in zonelist:
        ...
        domName = input("Insert a name for your domain: ")
